      ...
      <div style={styles.page}>
        ...
        <div style={styles.content}>
          ...
          {snapshots.map((snapshot, index, array) =>
            <div key={snapshot.PublicURL} style={{ paddingBottom: '30px', textAlign: 'left' }}>
              {
                hasNotPreviousDate(index, array, snapshot) && <DateSeparator snapshot={snapshot}></DateSeparator>
              }
...
const hasNotPreviousDate = (index: number, array: Snapshot[], snapshot: Snapshot) =>
